module.exports = function renderDetailsView(item) {
  const {c, getStars, $detailsView, customizeButton} = this
      ...
      c('div', {'class': 'col-xs-1'}, [
        c('div', {'class': 'row'}, [
          c('div', {'class': 'col-xs-12'}, [
            c('img', {'class': 'thumbnailed image', 'src': item.image2})
          ])
        ]),
        c('div', {'class': 'row'}, [
          c('div', {'class': 'col-xs-12'}, [
            c('img', {'class': 'thumbnailed image', 'src': item.image3})
          ])
        ]),
        c('div', {'class': 'row'}, [
          c('div', {'class': 'col-xs-12'}, [
            c('img', {'class': 'thumbnailed image', 'src': item.image4})
          ])
        ])
      ]),
